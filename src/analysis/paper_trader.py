...
Virtual trade logging and tracking for IBIT put spreads.
...
class PaperTrade:
    ...
    btc_iv_at_entry: Optional[float] = None
    ibit_price_at_entry: Optional[float] = None
...
class PaperTrader:
    """
    Paper trading simulator for IBIT put spreads.
    ...
    async def _create_table(self) -> None:
        ...
        await self.db._connection.execute("""
            CREATE TABLE IF NOT EXISTS paper_trades (
                ...
                pnl_dollars REAL,
                pnl_percent REAL,
                btc_iv_at_entry REAL,
                ibit_price_at_entry REAL,
    ...
    def _row_to_trade(self, row) -> PaperTrade:
        ...
        return PaperTrade(
            ...
            pnl_dollars=row[16],
            pnl_percent=row[17],
            btc_iv_at_entry=row[18],
            ibit_price_at_entry=row[19],
    ...
    async def open_trade(
        ...
        Args:
            ...
            btc_iv: Current BTC IV from Deribit
        ...
        trade = PaperTrade(
            ...
            btc_iv_at_entry=btc_iv,
            ibit_price_at_entry=recommendation.underlying_price,
        ...
        cursor = await self.db._connection.execute("""
            INSERT INTO paper_trades (
                ...
                entry_pop, status, btc_iv_at_entry, ibit_price_at_entry,
        ...
        """, (
            ...
            trade.btc_iv_at_entry, trade.ibit_price_at_entry,
        ...
        logger.info(
            ...
            f"IBIT ${trade.short_strike}/${trade.long_strike} for ${trade.entry_credit:.2f}"
        )
    ...
    async def check_exit_conditions(
        ...
        Args:
            current_ibit_price: Current IBIT price
        ...
        for trade in self._open_trades.copy():
            ...
            if dte <= 0:
                ...
                if current_ibit_price > trade.short_strike:
                    exit_debit = 0
